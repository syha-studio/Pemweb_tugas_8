  ...
  <body>
    ...
    <div class="container pt-2 pb-2">
      ...
      <div class="d-flex justify-content-center pt-3 pb-3">
        <h1 class="fw-bolder">Formulir - Data Ayah</h1>
      </div>
    <!-- Akhir Keterangan --> 
    
    <!-- Formulir -->
      <form action="FormDataIbu.php" method ="post" enctype="multipart/form-data" class="row g-3">
      <input type="text" name="tanggalPengisian" value="<?=$_POST["tanggalPengisian"]?>" hidden>
        ...
        <div class="mb-2">
          ...
          <input class="form-control" type="text" name="namaAyah" id="namaAyah" required autocomplete ="off">
        </div>
        <div class="mb-2">
          <label for="lahirAyah" class="form-label">Tahun Lahir</label>
          <select class="form-select" name="lahirAyah" id="lahirAyah" required>
        ...
        <div class="mb-2">
          ...
          <select class="form-select" name="pendidikanAyah" id="pendidikanAyah" required>
            <option selected></option>
        ...
        <div class="mb-2">
          ...
          <select class="form-select" name="pekerjaanAyah" id="pekerjaanAyah" required>
            <option selected></option>
        ...
        <div class="mb-2">
          <label for="penghasilanAyah" class="form-label">Penghasilan Bulanan</label>
          <select class="form-select" name="penghasilanAyah" id="penghasilanAyah" required>
            <option selected></option>
        ...
        <div class="mb-2">
          <label for="kebutuhanAyah" class="form-label">Berkebutuhan Khusus</label>
          <select class="form-select" name="kebutuhanAyah" id="kebutuhanAyah" required>
            <option selected></option>
        ...
        <div class="d-flex justify-content-center mb-3">
          <button type="submit" name="next3" class="btn btn-primary">Next</button>
        </div>
      </form>
    <!-- Akhir Formulir -->
    </div>
